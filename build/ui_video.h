...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        Widget->resize(969, 587);
        Widget->setStyleSheet(QString::fromUtf8("#Widget  { background-color: #f2f1f5; border-radius: 22px; }\n"
"* { color: #3d4150; }\n"
...
"QTimeEdit::down-button, QDateEdit::down-button, QDateTimeEdit::down-button, QSpinBox::down-button, QDoubleSpinBox::down-button { width:10px; height:10px; image:"
                        "url(:/icons/down.png); padding: 0px 8px 3px 0px; }\n"
...
"QTabBr::tab:selected { backg"
                        "round-color: #ffffff; border-bottom: none; }\n"
...
"#btn_personal_homePage, #btn_quit, #btn_scaledToSmall, #btn_littleshow {  border: "
                        "none; }\n"
...
""));
        ...
        gridLayout->addWidget(labelShow, 0, 0, 1, 1);
        ...
        control->setMinimumSize(QSize(100, 0));
        control->setMaximumSize(QSize(110, 16777215));
        control->setStyleSheet(QString::fromUtf8(""));
        labelHint = new QLabel(control);
        labelHint->setObjectName(QString::fromUtf8("labelHint"));
        labelHint->setGeometry(QRect(0, 200, 101, 31));
        QSizePolicy sizePolicy2(QSizePolicy::Minimum, QSizePolicy::Preferred);
        sizePolicy2.setHorizontalStretch(0);
        sizePolicy2.setVerticalStretch(0);
        sizePolicy2.setHeightForWidth(labelHint->sizePolicy().hasHeightForWidth());
        labelHint->setSizePolicy(sizePolicy2);
        ...
        layoutWidget->setGeometry(QRect(0, 0, 101, 181));
        verticalLayout = new QVBoxLayout(layoutWidget);
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        verticalLayout->setContentsMargins(0, 0, 0, 0);
        btnStartShare = new QPushButton(layoutWidget);
        btnStartShare->setObjectName(QString::fromUtf8("btnStartShare"));
        QSizePolicy sizePolicy3(QSizePolicy::Expanding, QSizePolicy::Fixed);
        sizePolicy3.setHorizontalStretch(0);
        sizePolicy3.setVerticalStretch(0);
        sizePolicy3.setHeightForWidth(btnStartShare->sizePolicy().hasHeightForWidth());
        btnStartShare->setSizePolicy(sizePolicy3);
        ...
        btnFull = new QPushButton(layoutWidget);
        btnFull->setObjectName(QString::fromUtf8("btnFull"));
        sizePolicy3.setHeightForWidth(btnFull->sizePolicy().hasHeightForWidth());
        btnFull->setSizePolicy(sizePolicy3);
        ...
        comboQuality = new QComboBox(layoutWidget);
        ...
        labelFPS = new QLabel(layoutWidget);
        ...
        labelByte = new QLabel(layoutWidget);
        ...
        gridLayout->addWidget(control, 0, 1, 1, 2);
    ...
    {
        Widget->setWindowTitle(QCoreApplication::translate("Widget", "\344\274\232\350\256\256\345\256\244", nullptr));
