...
public:
    ...
    void setupUi(QMainWindow *VideoPlayback)
    {
        if (VideoPlayback->objectName().isEmpty())
            VideoPlayback->setObjectName(QString::fromUtf8("VideoPlayback"));
        VideoPlayback->resize(777, 605);
        centralwidget = new QWidget(VideoPlayback);
        centralwidget->setObjectName(QString::fromUtf8("centralwidget"));
        centralwidget->setStyleSheet(QString::fromUtf8("#centralwidget  { background-color: #f2f1f5; border-radius: 22px; }\n"
"* { color: #3d4150; }\n"
...
""));
        ...
        widget = new Player(centralwidget);
        widget->setObjectName(QString::fromUtf8("widget"));

        verticalLayout->addWidget(widget);

        VideoPlayback->setCentralWidget(centralwidget);
    ...
    void retranslateUi(QMainWindow *VideoPlayback)
    {
        VideoPlayback->setWindowTitle(QCoreApplication::translate("VideoPlayback", "MainWindow", nullptr));
    } // retranslateUi
