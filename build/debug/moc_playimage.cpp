/****************************************************************************
** Meta object code from reading C++ file 'playimage.h'
**
...
#error "The header file 'playimage.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_PlayImage_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_PlayImage_t qt_meta_stringdata_PlayImage = {
    {
QT_MOC_LITERAL(0, 9) // "PlayImage"
...
const QMetaObject PlayImage::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_PlayImage.offsetsAndSize,
    qt_meta_data_PlayImage,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_PlayImage_t
, QtPrivate::TypeAndForceComplete<PlayImage, std::true_type>
