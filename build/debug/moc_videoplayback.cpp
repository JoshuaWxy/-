...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_VideoPlayback_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_VideoPlayback_t qt_meta_stringdata_VideoPlayback = {
    {
QT_MOC_LITERAL(0, 13) // "VideoPlayback"
...
const QMetaObject VideoPlayback::staticMetaObject = { {
    ...
    qt_meta_stringdata_VideoPlayback.offsetsAndSize,
    qt_meta_data_VideoPlayback,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_VideoPlayback_t
, QtPrivate::TypeAndForceComplete<VideoPlayback, std::true_type>
